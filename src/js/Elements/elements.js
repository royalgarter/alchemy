...
ELEMENTS.add("Plant$Pressure$", "Coal", "png", "Кам'яне Вугілля", "Каменный уголь");
...
ELEMENTS.add("Sand$Sand$", "Desert", "png", "Пустеля", "Пустыня");
...
ELEMENTS.add("Moon$Ocean$", "Tide", "png", "Прилив", "Прилив", "final");
...
ELEMENTS.add("Egg$Ocean$", "Hard roe", "png", "Червона Ікра", "Красная Икра");
...
ELEMENTS.add("City$Fog$", "Smog", "png", "Смог", "Смог");
...
ELEMENTS.add("Clock$Human$", "Watch", "png", "Годинник", "Наручные часы", "final");
...
ELEMENTS.add("Farmer$Plant$", "Wheat", "png", "Пшениця", "Пшеница");
ELEMENTS.add("Cold$Rain$", "Snow", "png", "Сніг", "Снег");
ELEMENTS.add("Sea$Unicorn$", "Narwhal", "png", "Нарвал", "Нарвал", "final");
...
ELEMENTS.add("Tree$Wind$", "Leaf", "png", "Листочок", "Лист");
...
ELEMENTS.add("House$Ice$", "Igloo", "png", "Іглу", "Иглу", "final");
...
ELEMENTS.add("Corpse$Wood$", "Coffin", "png", "Труна", "Гроб", "final");
...
ELEMENTS.add("Broom$Electricity$", "Vacuum cleaner", "png", "Пилосос", "Пылесос");
